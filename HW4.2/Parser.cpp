...
Parser::Parser(Grammar *newGrammar, SymbolTable *newSymTab)
        : myGrammar(newGrammar), numVar(0), numFunc(0), numStmt(0), isDeclaration(false),
          tokenVector(new std::vector<Token *>()), mySymTab(newSymTab) {
